...
def upConv(filters):
    return layers.Conv2DTranspose(filters, kernel_size=(2, 2),strides=2, activation='relu', padding='same')
...
def unet(input_shape):
    ...
    u5 = upConv(64)(c5)
    c6 = layers.Concatenate(axis=-1,name='conc1')([c4,u5])
    ...
    u6 = upConv(32)(c6)
    c7 = layers.Concatenate(axis=-1,name='conc2')([c3,u6])

    c7 = conv2d_3x3(64)(c7)
    c7 = conv2d_3x3(32)(c7)

    u7 = upConv(16)(c7)
    c8 = layers.Concatenate(axis=-1,name='conc3')([c2,u7])

    c8 = conv2d_3x3(32)(c8)
    c8 = conv2d_3x3(16)(c8)

    u8 = upConv(8)(c8)
    c9 = layers.Concatenate(axis=-1,name='conc4')([c1,u8])
    c9 = conv2d_3x3(16)(c9)
